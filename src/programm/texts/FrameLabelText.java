...
public class FrameLabelText {
    ...
    //Working Day Texts
    private static String WD_DATE_PICKER_LABEL = "Рабочий день";
    private static String WD_TIME_LABEL = "Рабочие часы";

    private static String WD_START_TIME_LABEL = "Начало работы";
    private static String WD_END_TIME_LABEL = "Конец работы";

    private static String WD_LUNCH_LABEL = "Время обеда";

    private static String WD_START_LUNCH_LABEL = "Начало обеда";
    private static String WD_END_LUNCH_LABEL = "Конец обеда";

    private static String WD_SHOW_PREVIOUS_WD_CHECK = "Показать прошедшие дни";

    private static String NO_LUNCH_LABEL = "Нет обеда";
    ...
    public static String getWdDatePickerLabel() {
        return WD_DATE_PICKER_LABEL;
    }

    public static String getWdTimeLabel() {
        return WD_TIME_LABEL;
    }

    public static String getWdStartTimeLabel() {
        return WD_START_TIME_LABEL;
    }

    public static String getWdEndTimeLabel() {
        return WD_END_TIME_LABEL;
    }

    public static String getWdLunchLabel() {
        return WD_LUNCH_LABEL;
    }

    public static String getWdStartLunchLabel() {
        return WD_START_LUNCH_LABEL;
    }

    public static String getWdEndLunchLabel() {
        return WD_END_LUNCH_LABEL;
    }

    public static String getWdShowPreviousWdCheck() {
        return WD_SHOW_PREVIOUS_WD_CHECK;
    }

    public static String getNoLunchLabel() {
        return NO_LUNCH_LABEL;
    }
}
