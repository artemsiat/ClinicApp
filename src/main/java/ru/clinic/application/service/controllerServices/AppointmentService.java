...
import ru.clinic.application.dao.AppointmentDao;
...
public class AppointmentService {
    ...
    public ObservableList<TimeInterval> getAppointmentsByWd(WorkingDay workingDay) {
        ...
        if (workingDay != null) {
            ObservableList<TimeInterval> appointments = appointmentDao.loadByWorkingDay(workingDay);
...
/*        Getting map of available minutes for each available hour and the same map for appointment
    ...
    public ObservableList<TimeInterval> loadAppointments(WorkingDay workingDay) {
        return appointmentDao.loadByWorkingDay(workingDay);
    }
    ...
    public ObservableList<TimeInterval> loadAppointmentsByPatient(int patientId) {
        return appointmentDao.loadByPatientId(patientId);
    }
    ...
    public ObservableList<TimeInterval> loadForDoctorsAndDate(ObservableList<Doctor> doctors, LocalDate dateValue) {
        return appointmentDao.loadForDoctorsAndDate(doctors, dateValue);
    }
}
