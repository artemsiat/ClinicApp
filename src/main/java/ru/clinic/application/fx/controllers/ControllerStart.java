...
import ru.clinic.application.fx.frames.FrameRoot;
...
public class ControllerStart {
    ...
    private final static String CONFIRMATION_HEADER = "Не получается рапознать все необходимые таблици для запуска программы. \nДля продолжения нажмите ОК.";
