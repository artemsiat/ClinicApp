...
public class ControllerPatients extends ControllerClass {
    ...
    void mouseReleasedButtonNewAppointment(MouseEvent event) {
        ...
        if (selectedPatient != null){
            ...
            AppAllerts.informationAlert(AlertType.INFORMATION_TITLE, AlertMessage.PATIENT_NOT_SELECTED);
        }
    }
    ...
    void addPatientBtnAction(ActionEvent event) {
        if (checkInputFields()) {
            ...
            AppAllerts.informationAlert(AlertType.INFORMATION_TITLE, AlertMessage.NOT_ALL_FIELDS_ARE_FILLED_FOR_NEW_PATIENT);
        }
    }
    ...
    void findBtnAction(ActionEvent event) {
        if (checkFindFields()) {
            ...
            AppAllerts.informationAlert(AlertType.INFORMATION_TITLE, AlertMessage.FILL_FIELDS_FOR_PATIENT_SEARCH);
            patientsTable.setItems(patientsService.loadLastCreatedPatients());
            patientsTable.refresh();
        }
